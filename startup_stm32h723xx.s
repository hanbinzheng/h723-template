...
/* start address of corresponding sections in FLASH (LMA) */
.word  _siitcm_text
/* start of ITCMRAM run time address (VMA) */
.word  _sitcm_text
/* end of ITCMRAM run time address */
.word  _eitcm_text
...
/* Copy the code segments from FLASH to ITCMRAM */
  ldr r0, =_sitcm_text
  ldr r1, =_eitcm_text
  ldr r2, =_siitcm_text
  movs r3, #0
